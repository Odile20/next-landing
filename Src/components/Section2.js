...
import Illustration1 from '../../public/Assets/Illustration1.svg'
const Section2 = () => {
    return (
        <div className='flex mx-32 space-x-32 my-20'>
            <div className='w-1/2 mr-10'>
                <div className='w-96 text-[background: #1A1445] text-4xl font-semibold'>
                    <p>Find Nearby Exciting Events </p><br />
                </div>
                <div className="">
            ...
            <div>
                <Image src={Illustration1} alt='illustration1'></Image>
            </div>
        </div>
    );
};
